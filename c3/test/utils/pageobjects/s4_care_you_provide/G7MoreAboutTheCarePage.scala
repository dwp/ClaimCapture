 ...
 *         Date: 29/07/2013
 */
final class G7MoreAboutTheCarePage (browser: TestBrowser, previousPage: Option[Page] = None) extends ClaimPage(browser, G7MoreAboutTheCarePage.url, G7MoreAboutTheCarePage.title, previousPage) {
...
object G7MoreAboutTheCarePage {
  ...
  def apply(browser: TestBrowser, previousPage: Option[Page] = None) = new G7MoreAboutTheCarePage(browser,previousPage)
}
...
trait G7MoreAboutTheCarePageContext extends PageContext {
  ...
  val page = G7MoreAboutTheCarePage (browser)
}