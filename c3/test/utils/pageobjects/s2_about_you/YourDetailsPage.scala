 ...
 *         Date: 09/07/2013
 */
final class YourDetailsPage(browser: TestBrowser, previousPage: Option[Page] = None) extends Page(browser, YourDetailsPage.url, YourDetailsPage.title, previousPage) {
  /**
