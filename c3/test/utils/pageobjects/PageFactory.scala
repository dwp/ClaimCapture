...
import utils.pageobjects.s3_your_partner.{G3MoreAboutYourPartnerPage, G4PersonYouCareForPage, G2YourPartnerContactDetailsPage, G1YourPartnerPersonalDetailsPage}
