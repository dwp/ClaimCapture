...
final class G6MoneyOwedByEmployerPage(browser: TestBrowser, previousPage: Option[Page] = None, iteration: Int) extends ClaimPage(browser, G6MoneyOwedByEmployerPage.url.replace(":jobID", iteration.toString), G6MoneyOwedByEmployerPage.title, previousPage, iteration) {
