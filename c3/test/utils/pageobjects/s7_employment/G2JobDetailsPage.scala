...
final class G2JobDetailsPage(browser: TestBrowser, previousPage: Option[Page] = None, iteration: Int)
  extends Page(browser, G2JobDetailsPage.url.replace(":jobID", iteration.toString), G2JobDetailsPage.title, previousPage, iteration) {
