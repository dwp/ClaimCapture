 ...
 */
abstract class WithApplication(val app: FakeApplication = LightFakeApplication()) extends Around with Scope {
 ...
 */
abstract class WithServer(val app: FakeApplication = LightFakeApplication(),
...
abstract class WithBrowser[WEBDRIVER <: WebDriver](
                                                    ...
                                                    val app: FakeApplication = LightFakeApplication(),
                                                    val port: Int = Helpers.testServerPort) extends Around with Scope {
