...
import controllers.{Navigation, Formulate, BrowserMatchers}
...
class G2AbroadForMoreThan4WeeksIntegrationSpec extends Specification with Tags {
  "Abroad for more that 4 weeks" should {
    ...
    "provide for trip entry" in new WithBrowser with Navigation with BrowserMatchers {
      browser goTo "/time-spent-abroad/abroad-for-more-than-4-weeks"
      titleMustEqual("When you went abroad for more than 4 weeks - Time Spent Abroad")
    ...
    """present "52 weeks trips" when no more 4 week trips are required""" in new WithBrowser with Navigation with BrowserMatchers {
      browser goTo "/time-spent-abroad/abroad-for-more-than-4-weeks"
      titleMustEqual("When you went abroad for more than 4 weeks - Time Spent Abroad")
    ...
    """go back to "normal residence and current location".""" in new WithBrowser with Navigation with BrowserMatchers {
    ...
    """not record the "yes/no" answer upon starting to add a new 4 weeks trip but "cancel".""" in new WithBrowser with Navigation with BrowserMatchers {
      browser goTo "/time-spent-abroad/abroad-for-more-than-4-weeks"
      titleMustEqual("When you went abroad for more than 4 weeks - Time Spent Abroad")
    ...
    """allow a new 4 weeks trip to be added but not record the "yes/no" answer""" in new WithBrowser with Navigation with BrowserMatchers {
      def trip() = {
    ...
    """remember "no more 4 weeks trips" upon stating "4 weeks trips" and returning""" in new WithBrowser with Navigation with BrowserMatchers {
      browser goTo "/time-spent-abroad/abroad-for-more-than-4-weeks"
      titleMustEqual("When you went abroad for more than 4 weeks - Time Spent Abroad")
