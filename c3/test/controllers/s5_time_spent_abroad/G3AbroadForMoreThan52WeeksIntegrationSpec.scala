...
class G3AbroadForMoreThan52WeeksIntegrationSpec extends Specification with Tags {
  "Abroad for more that 52 weeks" should {
    ...
    """present "completed" when no more 52 week trips are required""" in new WithBrowser with Navigation with BrowserMatchers {
      browser goTo "/time-spent-abroad/abroad-for-more-than-52-weeks"
      titleMustEqual("When you went abroad for more than 52 weeks - Time Spent Abroad")
    ...
    """go back to "abroad for more than 4 weeks".""" in new WithBrowser with Navigation with BrowserMatchers {
    ...
    """not record the "yes/no" answer upon starting to add a new 52 weeks trip but "cancel".""" in new WithBrowser with Navigation with BrowserMatchers {
      browser goTo "/time-spent-abroad/abroad-for-more-than-52-weeks"
      titleMustEqual("When you went abroad for more than 52 weeks - Time Spent Abroad")
    ...
    """allow a new 52 weeks trip to be added but not record the "yes/no" answer""" in new WithBrowser with Navigation with BrowserMatchers {
      def trip() = {
    ...
    """remember "no more 52 weeks trips" upon stating "52 weeks trips" and returning""" in new WithBrowser with Navigation with BrowserMatchers {
      browser goTo "/time-spent-abroad/abroad-for-more-than-52-weeks"
      titleMustEqual("When you went abroad for more than 52 weeks - Time Spent Abroad")
