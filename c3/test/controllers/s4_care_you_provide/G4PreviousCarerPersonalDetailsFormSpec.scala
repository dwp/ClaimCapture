  ...
  "More About The Person Form" should {
    ...
    "contain all mandatory data" in {
      ...
      form.errors should containAllOf(FormError("firstName", "error.required") ::
                                      FormError("surname", "error.required") :: Nil).only
    }
    ...
    "reject too long first name" in {
      ...
      form.errors should contain(FormError("firstName", "error.maxLength", Array(35))).only
    }
    ...
    "reject too long middle name" in {
      ...
      form.errors should contain(FormError("middleName", "error.maxLength", Array(35))).only
    }
    ...
    "reject too long surname" in {
      ...
      form.errors should contain(FormError("surname", "error.maxLength", Array(35))).only
    }
    ...
    "reject invalid national insurance number" in {
      ...
      form.errors should contain(FormError("nationalInsuranceNumber", "error.nationalInsuranceNumber")).only
    }
    ...
    "reject invalid date that has characters instead of numbers" in {
      ...
      form.errors should contain(FormError("dateOfBirth.day", "error.number")).only
    }
    ...
    "reject invalid date that has year higher than maximum allowed" in {
      ...
      form.errors should contain(FormError("dateOfBirth", "error.invalid")).only
    }
