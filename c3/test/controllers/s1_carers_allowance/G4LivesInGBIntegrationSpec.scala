...
class G4LivesInGBIntegrationSpec extends Specification with Tags {
  ...
  "Do you normally live in Great Britain" should {
    ...
    "acknowledge yes" in new WithBrowser with G1BenefitsPageContext {
      ...
      val hoursPage = page submitPage(waitForPage = true, waitDuration = 600)
      hoursPage fillPageWith claim
      val over16Page = hoursPage submitPage(waitForPage = true, waitDuration = 600)
      over16Page fillPageWith claim
      val livingGBPage = over16Page submitPage(waitForPage = true, waitDuration = 600)
      ...
      livingGBPage submitPage(waitForPage = true, waitDuration = 600)
