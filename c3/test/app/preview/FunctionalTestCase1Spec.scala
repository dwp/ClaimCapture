  ...
  "The application Claim" should {
    ...
    "Successfully run absolute Claim Test Case 1" in new WithJsBrowser with PageObjects {
      ...
      val toFindData = Data.build(
        ...
        "Have you or anyone in your family claimed or been paid any benefits or pensions from an EEA country since your claim date?"          displays "OtherMoneyOtherAreYouReceivingPensionFromAnotherEEA",
        "Have you or anyone in your family worked or paid national insurance in an EEA country since your claim date?" displays "OtherMoneyOtherAreYouPayingInsuranceToAnotherEEA",
