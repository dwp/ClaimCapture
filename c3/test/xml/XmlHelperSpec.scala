...
class XmlHelperSpec extends Specification with Tags {
  ...
  "construct an other question" in {
    ...
    "when question has why option" in new WithApplication{
      XMLHelper.questionWhy(<Test/>,"s7.g2", "No", Some("Maybe")).toString shouldEqual "<Test><QuestionLabel>"+employedQuestion+"</QuestionLabel><Answer>No</Answer><Why>Maybe</Why></Test>"
    }
