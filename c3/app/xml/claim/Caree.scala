...
object Caree extends XMLComponent {
  ...
  private def createMoreAboutCareFromXml(xml: NodeSeq) = {
    ...
    MoreAboutTheCare(spent35HoursCaring = createYesNoText((claimant \ "Cared35Hours" \ "Answer").text), otherCarer = createStringOptional(createYesNoText((claimant \ "OtherCarer" \ "Answer").text)))
  }
}
