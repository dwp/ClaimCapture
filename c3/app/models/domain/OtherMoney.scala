...
case class StatutorySickPay(haveYouHadAnyStatutorySickPay: String,
                            ...
                            howOften_frequency: Option[PaymentFrequency],
...
case class OtherStatutoryPay(otherPay:String, howMuch:Option[String], howOften:Option[PaymentFrequency], employersName:Option[String], employersAddress:Option[MultiLineAddress], employersPostcode:Option[String], call:Call) extends QuestionGroup(StatutorySickPay)
