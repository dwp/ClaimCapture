...
trait CachedClaim extends ClaimHandling {
  ...
  override def copyInstance(claim: Claim): Claim = new Claim(claim.key, claim.sections, claim.created, claim.lang, claim.gacid, claim.uuid, claim.transactionId, claim.checkYAnswers, claim.saveForLaterCurrentPageData)(claim.navigation)
