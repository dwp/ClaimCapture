...
object G8AboutExpenses extends Controller with CachedClaim with Navigable {
  val form = Form(mapping(
    ...
    "jobTitle" -> optional(carersNonEmptyText(maxLength = 30)),
    "whatExpensesForJob" -> optional(nonEmptyText(maxLength = 100)),
    "payAnyoneToLookAfterChildren" -> nonEmptyText.verifying(validYesNo),
    "nameLookAfterChildren" -> optional(nonEmptyText(maxLength = 100)),
    "howMuchLookAfterChildren" -> optional(nonEmptyText verifying validCurrency5Required),
    ...
    "nameLookAfterPerson" -> optional(nonEmptyText(maxLength = 100)),
    "howMuchLookAfterPerson" -> optional(nonEmptyText verifying validCurrency5Required),
