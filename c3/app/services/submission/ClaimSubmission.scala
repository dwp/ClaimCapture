...
case class ClaimSubmission(claim: Claim, transactionId: String) {
  ...
  private def buildClaimant = {
    <Claimant>
      <DateOfClaim>
        {aboutYou.claimDate.dateOfClaim.toXmlString}
      </DateOfClaim>
      <Surname>
        {aboutYou.yourDetails.surname}
      </Surname>
      <OtherNames>
        {s"${aboutYou.yourDetails.firstName} ${aboutYou.yourDetails.middleName.getOrElse("")}"}
      </OtherNames>
      <OtherSurnames>
        {aboutYou.yourDetails.otherSurnames.orNull}
      </OtherSurnames>
      <Title>
        {aboutYou.yourDetails.title}
      </Title>
      <MaritalStatus>
        {aboutYou.yourDetails.maritalStatus}
      </MaritalStatus>
      <DateOfBirth>
        {aboutYou.yourDetails.dateOfBirth.toXmlString}
      </DateOfBirth>
      <NationalInsuranceNumber>
        {aboutYou.yourDetails.nationalInsuranceNumber.orNull}
      </NationalInsuranceNumber>
      <Address>
        <gds:Line>
          {aboutYou.contactDetails.address.lineOne.orNull}
        </gds:Line>
        <gds:Line>
          {aboutYou.contactDetails.address.lineTwo.orNull}
        </gds:Line>
        <gds:Line>
          {aboutYou.contactDetails.address.lineThree.orNull}
        </gds:Line>
        <gds:PostCode>
          {aboutYou.contactDetails.postcode.orNull}
        </gds:PostCode>
      </Address>
      <ConfirmAddress>yes</ConfirmAddress> <!-- Always default to yes -->
      <HomePhoneNumber>
        {aboutYou.contactDetails.mobileNumber.orNull}
      </HomePhoneNumber>
      <DaytimePhoneNumber>
        <Number>
          {aboutYou.contactDetails.phoneNumber.orNull}
        </Number>
        <Qualifier/>
      </DaytimePhoneNumber>
      <EmailAddress/>
